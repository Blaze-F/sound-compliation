"""
Django settings for tts_crud_service project.
...
INSTALLED_APPS = [
    ...
    "tts_project_management.apps.TtsProjectManagementConfig",
]
...
ROOT_URLCONF = "tts_crud_service.urls"
...
WSGI_APPLICATION = "tts_crud_service.wsgi.application"
